...
def mask_account_card(name_number: str) -> str:
    ...
    if name_number[:4] == "Счет":

        return str(get_mask_account(name_number))
    else:
        return str(get_mask_card_number(name_number))
...
def get_date(date: str) -> str:
    """Принимает троку формата: 2024-03-11T02:26:18.671407
